...
from nn_dataflow.core import MapStrategyWS
...
def do_scheduling(args):
    ...
    nnd = NNDataflow(network, batch_size, resource, cost, MapStrategyWS)
    tbeg = time.time()
...
def main():
    ...
    with open(os.path.join(script_dir, 'ws_alex_net.json'), 'w') as outfile:
